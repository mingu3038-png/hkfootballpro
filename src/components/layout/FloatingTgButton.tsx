...
/** 全站 TG 浮动悬浮按钮 · 滚动时常驻，跳转 Telegram */
export function FloatingTgButton() {
  return (
    <a
      ...
      aria-label={`${FLOATING_TG_CTA_LABEL}，前往 Telegram`}
    >
      <span className="floating-tg-btn__halo" aria-hidden />
